...
import { signInWithRedirect, FacebookAuthProvider, browserPopupRedirectResolver } from '@firebase/auth';
...
@Component({
  ...
  styleUrl: 'facebook-auth-button.css',
  shadow: true,
})
export class FacebookAuthButton {
  ...
  onClick = (e: MouseEvent) => {
    ...
    this.form.auth.then(auth => signInWithRedirect(auth, new FacebookAuthProvider(), browserPopupRedirectResolver));
  }
