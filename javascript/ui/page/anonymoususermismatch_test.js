...
/**
 * @fileoverview Tests for the anonymous user mismatch error page.
 */

goog.provide('firebaseui.auth.ui.page.AnonymousUserMismatchTest');
goog.setTestOnly('firebaseui.auth.ui.page.AnonymousUserMismatchTest');
...
function setUp() {
  ...
  component = new firebaseui.auth.ui.page.AnonymousUserMismatch(
      goog.bind(
...
function testAnonymousUserMismatch_pageEvents() {
...
function testAnonymousUserMismatchError_getPageId() {
  assertEquals('anonymousUserMismatch', component.getPageId());
}
