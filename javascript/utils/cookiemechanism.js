...
firebaseui.auth.CookieMechanism =
    function(opt_maxAge, opt_path, opt_domain, opt_secure) {
...
goog.inherits(
    firebaseui.auth.CookieMechanism, goog.storage.mechanism.Mechanism);
 ...
 * @override
 */
firebaseui.auth.CookieMechanism.prototype.get = function(key) {
 ...
 * @override
 */
firebaseui.auth.CookieMechanism.prototype.remove = function(key) {
