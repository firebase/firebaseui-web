...
import { Component, ElementRef, EventEmitter, Output, computed, effect, input, signal, viewChild } from "@angular/core";
import {
  FirebaseUIError,
  getTranslation,
...
import { TanStackAppField, TanStackField, injectForm, injectStore } from "@tanstack/angular-form";
