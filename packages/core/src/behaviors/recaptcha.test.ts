...
describe("Recaptcha Verification Handler", () => {
  ...
  describe("recaptchaVerificationHandler", () => {
    ...
    it("should pass correct auth instance", () => {
      ...
      expect(RecaptchaVerifier).toHaveBeenCalledWith(customAuth, mockElement, expect.any(Object));
    });
    ...
    it("should pass correct element", () => {
      ...
      expect(RecaptchaVerifier).toHaveBeenCalledWith(mockUI.auth, customElement, expect.any(Object));
    });
  });
  ...
  describe("RecaptchaVerificationOptions", () => {
    it("should accept all valid size options", () => {
      ...
      sizes.forEach((size) => {
        ...
        expect(RecaptchaVerifier).toHaveBeenCalledWith(mockUI.auth, mockElement, expect.objectContaining({ size }));
        expect(result).toBeDefined();
      });
    });
    ...
    it("should accept all valid theme options", () => {
      ...
      themes.forEach((theme) => {
        ...
        expect(RecaptchaVerifier).toHaveBeenCalledWith(mockUI.auth, mockElement, expect.objectContaining({ theme }));
        expect(result).toBeDefined();
      });
    });
